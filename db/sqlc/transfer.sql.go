...
func (q *Queries) ListTransfersFromAccount(ctx context.Context, arg ListTransfersFromAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, listTransfersFromAccount, arg.Limit, arg.Offset, arg.FromAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListTransfersToAccount(ctx context.Context, arg ListTransfersToAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, listTransfersToAccount, arg.Limit, arg.Offset, arg.ToAccountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
